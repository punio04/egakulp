...
$require = array('あなたの今のお気持ちは？、どのような業界を希望していますか？', '現在のお仕事内容は？', 'お仕事の状況', 'ご希望の働き方', 'ご希望の時間帯', 'いつ頃の転職をご希望ですか？', 'お住まいの郵便番号', '性別', '生年月日', 'お名前', '電話番号');
...
$re_subject = "えがくキャリアにお問い合わせありがとうございます。";
...
<?php
        ...
        function mailToAdmin($arr, $subject, $mailFooterDsp, $mailSignature, $encode, $confirmDsp)
        {
            ...
            $adminBody .= "" . date("Y/m/d (D) H:i:s", time()) . "," . @$_POST['名前'] . "," . @$_POST['ふりがな'] . ",'" . @$_POST['電話番号'] . "," . @$_POST['お電話がつながりやすい時間帯'] . "," . @$_POST['年齢'] . "," . @$_POST['いつ転職をお考えですか？'] . "," . @$_POST['最終学歴を教えてください'] . "," . @$_POST['ご希望の勤務地を教えてください'] . ",LP-A\n";
            $adminBody .= "＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝\n\n";
